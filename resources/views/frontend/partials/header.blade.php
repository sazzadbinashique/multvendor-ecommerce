            ...
            <div class="container">
                <div class="mid-section main-info-area">
                    ...
                    <div class="wrap-logo-top left-section">
                        <a href="{{url('/')}}" class="link-to-home"><img src="{{asset('assets/images/logo.png')}}" alt="mercado"></a>
                    </div>
                    ...
                    <div class="wrap-icon right-section">
                        ...
                        <div class="wrap-icon-section minicart">
                            <a href="{{route('cart')}}" class="link-direction">
                                ...
                                <div class="left-info">
                                    <span class="index">{{Cart::content()->count()}}</span>
                                    <span class="title"><a href="{{route('cart')}}">CART</a></span>
                                </div>
                            </a>
                        </div>
                ...
                <div class="primary-nav-section">
                    <div class="container">
                        <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
                            ...
                            <li class="menu-item">
                                <a href="{{route('shop.category')}}" class="link-term mercado-item-title">All Category</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{route('shops')}}" class="link-term mercado-item-title">All Shop</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{route('brands')}}" class="link-term mercado-item-title">All Band</a>
                            </li>
                            <li class="menu-item">
