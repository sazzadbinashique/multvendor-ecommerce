                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <form action="{{route('merchant.categories.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                {{csrf_field()}}
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <a href="{{route('merchant.categories.index')}}" class="btn btn-info">Cancel</a>
