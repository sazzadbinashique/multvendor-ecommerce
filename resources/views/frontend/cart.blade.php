                        ...
                        @foreach(Cart::content() as $pdt)
                            <li class="pr-cart-item">
                                ...
                                <div class="product-name">
                                    <a class="link-to-product" href="#">{{$pdt->name}}</a>
                                </div>
                                ...
                                <div class="price-field produtc-price"><p class="price">${{ $pdt->price }}</p></div>
                                <div class="quantity">
                                    <div class="quantity-input">
                                        <a href="{{ route('cart.decr', [ $pdt->rowId,  $pdt->qty] ) }}" class="quantity-minous">-</a>
                                        <a href="{{ route('cart.incr', [ $pdt->rowId,  $pdt->qty ]) }}" class="quantity-plus">+</a>
                                        <input type="text" value="{{ $pdt->qty }}" data-max="120" pattern="[0-9]*" >
                                    </div>
                                </div>
                                <div class="price-field sub-total"><p class="price">${{ $pdt->total() }}</p></div>
                                <div class="delete">
                                    <a href="{{route('cart.delete', $pdt->rowId)}}" class="btn" title="">
